...
DASHBOARDS = {
    ...
    "instructor": {
        ...
        "menu": [
            {"icon": "fa-layer-group",     "label": "Mis Fichas",       "endpoint": "instructor_fichas"},
            {
                "icon": "fa-clipboard-check",
                "label": "Evaluación",
                "endpoint": "dashboard",
    ...
    "empresa": {
        "role": "Empresa",
        "icon": "fa-building",
        "area": "Etapa productiva",
        "title": "Tablero Empresa",
        "text": "Seguimiento de aprendices en etapa productiva y gestión de contratos de aprendizaje.",
        "footer": "BARÍ LMS SENA - Empresa",
        "menu_heading": "Empresa",
        "menu": [
            {
                "icon": "fa-users",
                "label": "Mis aprendices",
                "endpoint": "dashboard",
                "endpoint_kwargs": {"role_slug": "empresa"},
            },
            {
        ...
        "metrics": [
            {"label": "Aprendices activos",    "value": "0", "icon": "fa-user-graduate"},
            {"label": "Contratos vigentes",    "value": "0", "icon": "fa-file-contract"},
            {"label": "Por vencer (30 días)",  "value": "0", "icon": "fa-clock"},
            {"label": "Evaluaciones pend.",    "value": "0", "icon": "fa-clipboard-list"},
        ],
        "tasks_title": "Pendientes",
        "tasks": [
            {"title": "Seguimiento",   "text": "Revisar avance de aprendices en etapa productiva."},
            {"title": "Evaluaciones",  "text": "Registrar evaluaciones de desempeño pendientes."},
            {"title": "Contratos",     "text": "Verificar vencimientos y renovaciones próximas."},
        ],
        "table_title": "Aprendices en práctica",
        "table_headers": ["Aprendiz", "Programa", "Estado"],
        "table_rows": [],
    },
}
